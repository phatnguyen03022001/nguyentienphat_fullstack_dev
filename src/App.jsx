          ...
          <div className="hero-grid">
            <motion.div className="hero-copy" initial={shouldReduceMotion ? false : "hidden"} animate={shouldReduceMotion ? false : "visible"} variants={fadeUp}>
              ...
              <div className="hero-actions">
                <a className="button button-primary" href="#work">View my work <FiArrowDown aria-hidden="true" /></a>
                <a className="button button-secondary" href={`mailto:${profile.email}`}>Let's talk <FiMail aria-hidden="true" /></a>
              </div>
