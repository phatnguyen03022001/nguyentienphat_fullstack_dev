...
export const projects = [
  {
    ...
    problem:
      "Teachers needed a simple way to create exams, manage questions and review student results.",
    solution:
  ...
  },
  {
    ...
    problem:
      "The project needed to connect hotel operations with a simple guest booking experience.",
    solution:
